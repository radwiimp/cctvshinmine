...
module.exports = function(s,config,lang){
    ...
    try{
        ...
        var onEventTriggerForEmail = function(d,filter){
			...
			setTimeout(function(){
  			  s.mergeDetectorBufferChunksAfter(d,d.currentTimestamp,function(mergedFilepathMore,filenameMore){
                            fs.readFile(mergedFilepathMore,function(err,bufferMore){
                                if(bufferMore){
                                    s.nodemailer.sendMail({
                                        from: config.mail.from,
                                        to: r.mail,
                                        subject: filenameMore,
                                        html: '',
                                        attachments: [
                                            {
                                                filename: filenameMore,
                                                content: bufferMore
                                            }
                                        ]
                                    }, (error, info) => {
